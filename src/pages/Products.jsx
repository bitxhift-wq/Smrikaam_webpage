...
export default function Products() {
  ...
  const products = useMemo(() => {
    ...
    return rawCmsProducts.map((item, idx) => {
      ...
      const businessProblemsRaw = item.problem || item.problemStatement || item.businessProblems || [
      ...
      return {
        ...
        technology: Array.isArray(item.technology) && item.technology.length > 0
          ? item.technology
          : (Array.isArray(item.techStack) && item.techStack.length > 0 ? item.techStack : ['MQTT', 'OPC-UA', 'Node-RED', 'TimescaleDB', 'Docker Edge', 'React', 'Python']),
                ...
                >
                  ...
                  <div className="border-t border-border/70 pt-6">
                    ...
                    <ul className="space-y-2">
                      {activeProduct.businessProblems.map((prob, i) => (
                  ...
                  {/* Related Asset & Case Study Links */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2 border-t border-border/70 text-[13px]">
                    <div className="p-3.5 border border-border/70 flex flex-col justify-between">
                      ...
                      <Link to="/industries" className="text-text font-semibold hover:text-accent transition-colors inline-flex items-center gap-1.5 group/acc">
                        <span>{activeProduct.category || 'Enterprise Transformation'}</span>
                    ...
                    <div className="p-3.5 border border-border/70 flex flex-col justify-between">
                      ...
                      <Link to={activeProduct.caseStudySlug ? `/case-studies/${activeProduct.caseStudySlug}` : '/case-studies'} className="text-text font-medium hover:text-accent transition-colors inline-flex items-center gap-1.5 group/cs">
                        <span className="line-clamp-1">{activeProduct.caseStudy}</span>
