...
export default function Contact() {
  ...
  return (
    <div className="relative z-10 pt-28 pb-24 px-6 md:px-16 max-w-7xl mx-auto">
      {/* Header Banner */}
      <div id="overview" data-scroll-label="CONTACT" className="page-title-surface relative border border-border p-8 md:p-12 mb-16 overflow-hidden">
        <BannerDrawBorder />
      ...
      <div id="paths" data-scroll-label="ENGAGEMENT PATHS" className="mb-16">
          ...
          {engagementPaths.map((path, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="font-mono text-[10px] text-accent font-semibold mb-2">{path.subtitle}</div>
      ...
      {/* Form & Sidebar Grid */}
      <div id="form" data-scroll-label="INQUIRY FORM" className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        {/* Contact Form */}
        <div className="lg:col-span-7">
          <Reveal>
            <BlueprintWrapper pulseCorners={true} className="p-8 md:p-12 bg-bg/95 backdrop-blur-md">
              <h2 className="font-heading text-2xl font-bold uppercase text-text mb-6">
                ENGAGEMENT FORM
              </h2>

              {successMsg && (
                <div className="mb-6 p-4 border border-emerald-500 bg-emerald-50 text-emerald-800 font-mono text-xs flex items-center gap-3">
              ...
              {errorMsg && (
                <div className="mb-6 p-4 border border-rose-500 bg-rose-50 text-rose-800 font-mono text-xs flex items-center gap-3">
        ...
        <div className="lg:col-span-5 space-y-8">
          <Reveal index={1}>
            <BlueprintWrapper className="p-8 bg-bg/95 backdrop-blur-md">
              <div className="font-mono text-[13px] text-accent uppercase tracking-widest mb-2 font-medium">HEADQUARTERS</div>
              ...
              <div className="space-y-4 text-[15px] text-text-muted leading-[1.55]">
                <div className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 text-accent shrink-0 mt-1" strokeWidth={1.5} />
                  <div>
                    <div className="font-medium text-text">SMRIKAAM Technologies LLP</div>
                    <div>No. 19, Nataraj Nagar, Koundampalayam</div>
                    <div>Coimbatore, Tamil Nadu 641030, India</div>
                  </div>
                </div>
          ...
          <Reveal index={2}>
            <BlueprintWrapper className="p-8 bg-bg/90">
              <div className="font-mono text-[13px] text-accent uppercase tracking-widest mb-2 font-medium">GUARANTEED SLA</div>
